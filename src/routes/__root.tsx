...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Homem de Honra — 63 Dias Para Reconstruir Sua Disciplina" },
      ...
      { name: "author", content: "Homem de Honra" },
      { property: "og:title", content: "Homem de Honra — 63 Dias Para Renascer" },
      { property: "og:description", content: "De homem perdido no piloto automático para líder que inspira respeito. Quebre o ciclo da mediocridade para sempre." },
