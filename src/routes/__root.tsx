...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Homem de Honra — 63 Dias Para Reconstruir Sua Disciplina" },
      ...
      { name: "twitter:title", content: "Homem de Honra — 63 Dias Para Reconstruir Sua Disciplina" },
